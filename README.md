...
<!-- Please read the https://github.com/linuxserver/docker-pyload-ng/blob/develop/.github/CONTRIBUTING.md -->
...
* Shell access whilst the container is running: `docker exec -it pyload-ng /bin/bash`
* To monitor the logs of the container in realtime: `docker logs -f pyload-ng`
...
* Update all images: `docker-compose pull`
  * or update a single image: `docker-compose pull pyload-ng`
* Let compose update all containers as necessary: `docker-compose up -d`
  * or update a single container: `docker-compose up -d pyload-ng`
* You can also remove the old dangling images: `docker image prune`

### Via Docker Run

* Update the image: `docker pull lscr.io/linuxserver/pyload-ng:develop`
